...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Estimate coefficients using LMS Regressor algorithm
% Algorithm defined in LMS Regressor function
% Graph Teching signal, Estimated Signal and Error Signal on same plot
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% estimate using LMS Regressor function
[y_hat, error, est_coeff_mat] = lms_ar_regressor(y, mu, order);
