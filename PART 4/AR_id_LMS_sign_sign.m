...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Estimate coefficients using LMS Sign Sign algorithm
% Algorithm defined in LMS Sign Sign function
% Graph Teching signal, Estimated Signal and Error Signal on same plot
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% estimate using LMS Sign Sign function
[y_hat, error, est_coeff_mat] = lms_ar_sign_sign(y, mu, order);
